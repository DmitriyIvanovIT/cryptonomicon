...
export default {
  ...
  created() {
    const tickerData = localStorage.setItem('git -list');
    if (tickerData) {
  ...
  methods: {
    add() {
      ...
      setInterval(async () => {
        const f = await fetch(
          `https://min-api.cryptocompare.com/data/price?fsym=${newTicker.name}&tsyms=USD&api_key=08a2efba05cc5306418f11e079416a2ce9ee9d53eb4438ea63a430c56bbc2649`
        );
